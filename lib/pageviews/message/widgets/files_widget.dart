...
class FilesWidgetSlider extends StatefulWidget {
  final MessageModel model;
  final bool editable;

  const FilesWidgetSlider(this.model, [this.editable = true]);

  @override
  _FilesWidgetSliderState createState() => _FilesWidgetSliderState();
}

class _FilesWidgetSliderState extends State<FilesWidgetSlider> {
  @override
