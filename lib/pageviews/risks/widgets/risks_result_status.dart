...
class RisksResultStatus extends StatelessWidget {
  final bool success;
  final RisksModel model;

  const RisksResultStatus(this.model, [this.success = true]);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(S.current.assessmentRegistration),
      ),
      body: Center(child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              success
                  ? S.current.assessmentRegistered
                  : S.current.assessmentUnregistered,
            ...
            Text(
              success
                  ? S.current.followAssessmentStatus
                  : S.current.assessmentLocallySaved,
