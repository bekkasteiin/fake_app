...
class EventCalendar extends StatefulWidget {
  ...
  const EventCalendar(this.model);
...
class _EventCalendarState extends State<EventCalendar> {
  ...
  @override
  void initState() {
    activityModel = widget.model;
    today = DateTime.now();
    eventList = getEventsByDay(today, activityModel.risksEvents);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    children: [
      TableCalendar(
        ...
        events: activityModel.risksEvents,
