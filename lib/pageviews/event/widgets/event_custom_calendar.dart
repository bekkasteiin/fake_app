            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Center(
                    child: Text(
                      DateFormat.yMMMM(languageCode).format(currentMonthDate),
    ...
    for (var i = 0; i < 7; i++) {
      listUI.add(
        Expanded(
          child: Center(
            child: Text(
              DateFormat.E(languageCode).format(dateList[i]),
              style: generalFontStyle.copyWith(color: appGreyColor, fontWeight: FontWeight.w500),
            ),
          ),
        ),
      );
