...
class BsaFilesWidgetSlider extends StatefulWidget {
  final BsaModel model;
  final bool editable;

  const BsaFilesWidgetSlider(this.model, [this.editable = true]);

  @override
  _BsaFilesWidgetSliderState createState() => _BsaFilesWidgetSliderState();
}

class _BsaFilesWidgetSliderState extends State<BsaFilesWidgetSlider> {
  @override
